...
type (
	...
	// input: non-nil HttpResponse OR request execution error
	RetryConditionFunc func(*HttpResponse, error) bool

	// OnRetryFunc is for side-effecting functions triggered on retry
	OnRetryFunc func(*HttpResponse, error)
	...
	RetryAfterFunc func(*HttpClient, *HttpResponse) (time.Duration, error)
...
func sleepDuration(resp *HttpResponse, min, max time.Duration, attempt int) (time.Duration, error) {
